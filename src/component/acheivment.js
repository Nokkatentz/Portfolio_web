    ...
    return(
        <div id='acheiv-part'>
            ...
            <div id='acheiv-content'>
                ...
                <div id='uifry'>
                    <ManageAcheivment type = '1' head = 'Uifry' text = 'static website สำหรับจัดหางาน โดยได้ template มาจาก Figma community แล้วนำมาเขียนโดยการใช้ HTML และ CSS ซึ่งออกแบบ animation ภายในเว็บเอง' img = '/img/uifry.png'/>
                </div>
                <div id='hack'>
                    <ManageAcheivment type = '1' head = 'Hack club cucek' text = 'Static web site ทำขึ้นโดยใช้ React JS ซึ่งได้นำ template มาจาก Figma community เป็นเว็บไซต์เกี่ยวกับโรงเรียนที่สอนเขียนโค้ด และได้ออกแบบ animation ภายในเว็บไซต์เอง' img = '/img/hack.png'/>
                </div>
                <div id='mobile'>
